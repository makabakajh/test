...
import com.jeesite.common.shiro.realm.MyAuthorizingRealm;
...
public class ShiroConfig {
	 ...
	 * Form登录过滤器
	 */
	private FormFilter shiroAuthcFilter(MyAuthorizingRealm authorizingRealm) {
	 ...
	 * 登出过滤器
	 */
	private LogoutFilter shiroLogoutFilter(MyAuthorizingRealm authorizingRealm) {
	 ...
	 */
	@Bean
	public ShiroFilterFactoryBean shiroFilter(WebSecurityManager webSecurityManager, MyAuthorizingRealm authorizingRealm,
	 ...
	 */
	@Bean
	public MyAuthorizingRealm authorizingRealm(SessionDAO sessionDAO) {
		MyAuthorizingRealm bean = new MyAuthorizingRealm();
